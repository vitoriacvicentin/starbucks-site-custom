...
// console.log(pathsToModuleNameMapper(tsConfig.compilerOptions.paths, { prefix: '<rootDir>' }))
/*
...
module.exports = {
  ...
  moduleFileExtensions: [...defaults.moduleFileExtensions, 'ts', 'tsx', 'js', 'json', 'jsx'],
